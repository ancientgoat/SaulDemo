...
public class SaulDataDefinition implements SaulHasName {
    ...
    public static final String DATA_DEF_FILE_PATH = "saulgen/buildSrc/src/main/java/org/saul/datadefinition/dto";
...
//    }
    ...
    public String getOutputFileName() {
        final String fullFileName = String.format("%s/%s_%s%s", DATA_DEF_FILE_PATH, DATA_DEF_PREFIX, getIdentity().getName(),
                DATA_DEF_FILE_EXTENSION);
        return fullFileName;
    }
    ...
    public static final class Builder {
        ...
        public Builder(final SaulDataDefinition inDataDef) {
            ...
            //this.dataDefinition.fields = Lists.newArrayList(inDataDef.fields);
