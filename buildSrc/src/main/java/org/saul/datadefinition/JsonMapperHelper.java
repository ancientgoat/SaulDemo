...
public class JsonMapperHelper {
    ...
    private static String writeMapperToString(Object inObject, ObjectMapper inMapper) {
        try {
            final String outputString = inMapper.writerWithDefaultPrettyPrinter().writeValueAsString(inObject);
            return outputString;
        } catch (Exception e) {
     ...
     *
     */
    public static final void writeBeanToYamlFile(final String inOutputFileName, final Object inObject) {


        final String yamlString = writeMapperToString(inObject, newInstanceYaml());


        writeMapperToFile(inOutputFileName, yamlString);
    }
